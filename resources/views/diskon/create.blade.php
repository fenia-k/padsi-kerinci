...
<div class="container mx-auto p-6">
    <h2 class="text-3xl font-semibold text-primary mb-6">Tambah Diskon</h2>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('diskon.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="harga_diskon" id="harga_diskon" class="w-full p-2 border border-gray-300 rounded-lg @error('harga_diskon') border-red-500 @enderror" value="{{ old('harga_diskon') }}">
                @error('harga_diskon')
            ...
            <div class="mb-4">
                ...
                <input type="number" name="batas_pemakaian" id="batas_pemakaian" class="w-full p-2 border border-gray-300 rounded-lg @error('batas_pemakaian') border-red-500 @enderror" value="{{ old('batas_pemakaian') }}">
